...
export function GlowingShadow({ children, height = "100%", width = "100%", borderRadius = "0.75rem", onClick }: GlowingShadowButtonProps) {
    ...
    <>
      <style jsx>{`
        ...
        .glow-container:after {
          ...
          height: 100%;
          border-radius: var(--card-radius);
          pointer-events: none; /* Let clicks pass through if needed, though container handles click */
        }
        ...
        /* Removed .glow-content span styles as they interfere with children */

        .glow-content:before {
          content: "";
          display: block;
          position: absolute;
          /* Adjusted size to fit exactly or slightly larger for border effect */
          inset: -3px; 
          border-radius: var(--card-radius);
        ...
        .glow-container:hover .glow-content {
          mix-blend-mode: normal; /* Changed from darken to normal to preserve child colors */
      ...
      <div className="glow-container" role="button" onClick={onClick}>
