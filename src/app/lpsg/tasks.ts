...
export const TASKS: Task[] = [
  ...
  { id: "set-pixel-capi", frente: "setup", ordem: 5, sugestao: "victor", pendencia: true, recorrencia: "unica", label: "Confirmar Pixel + CAPI ativos (rastreamento server-side)", detalhe: "✅ CÓDIGO VALIDADO (Claude 14/07): Pixel 1543917230170877 no layout.tsx (PageView global) + IAA dispara ViewContent no load e InitiateCheckout no clique do CTA. CAPI ativa (Purchase+ViewContent+InitiateCheckout). FALTA só o teste ao vivo: abrir redpro.com.br/introducao-a-automacao e ver o evento no Gerenciador de Eventos da Meta (1 min)." },
