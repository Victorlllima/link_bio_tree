...
export const TASKS: Task[] = [
  ...
  { id: "grp-op-link", frente: "grupo", ordem: 8, sugestao: "victor", pendencia: true, recorrencia: "semanal", label: "[CICLO] Gerar o novo link de convite e atualizar em todo lugar que aponta pra ele", detalhe: "**Link do 1º ciclo (22/07): `chat.whatsapp.com/I3AcP8IpTtsG2y3gC7O0bS`** · nome visível do grupo: `🧩 DESAFIO: Seu CRM em 5 Dias 🚀`. ✅ Ligado nas 2 páginas de obrigado (`/desafio-crm/obrigado` e `/lpsg-obrigado`, corrigido por ION em 22/07 — estavam com o link de um grupo antigo) + ✅ tela final da Aula 12 do IAA. FALTA: ligar no ManyChat (grp-op-automacao). ⚠️ **A CADA CICLO:** grupo novo → link novo → trocar nos 3 pontos (2 páginas de obrigado + ManyChat). Links já aposentados: `IsvZFOVIYKmDss3tSRwrKx`, `Jtk4YdLJMFGK2S6LtUUkMr`." },
  ...
  { id: "grp-backup-criar", frente: "grupo", ordem: 10, sugestao: "victor", pendencia: true, recorrencia: "semanal", label: "[CICLO] Criar o GRUPO DE BACKUP do CRM Week (pós-compra do ingresso)", detalhe: "⚠️ OUTRO grupo, OUTRO público. O grupo de aquecimento (grp-op-criar) é de quem veio da Aula 12 do IAA e ainda NÃO comprou. Este é só de quem JÁ PAGOU o ingresso R$44 — serve de contingência antibloqueio (se o número 1:1 cair, os avisos chegam aqui) + antigolpe. Nome de criação: **🧩 CRM Week \\" },
  { id: "grp-backup-link", frente: "grupo", ordem: 11, sugestao: "victor", pendencia: true, recorrencia: "semanal", label: "[CICLO] Ligar o link do grupo de backup em todos os pontos de entrega", detalhe: "O link novo do ciclo entra em 3 lugares: (1) fluxo ManyChat pós-compra — passo (c) dos 3 obrigatórios do Tabari, (2) página de obrigado do ingresso, (3) mensagem de boas-vindas 1:1. Sem isso quem compra não chega no backup." },
  { id: "grp-nome-ciclo", frente: "grupo", ordem: 12, sugestao: "victor", pendencia: true, recorrencia: "semanal", label: "[CICLO] Trocar o NOME do grupo nos 7 marcos do ciclo (escassez visual)", detalhe: "Dispositivo de urgência do Tabari — o grupo sobe na lista do WhatsApp e a pessoa vê o estado do lançamento sem abrir. Sequência: criação `🧩 CRM Week \\" },
  { id: "grp-cap-4mais4", frente: "grupo", ordem: 13, sugestao: "ambos", pendencia: true, recorrencia: "semanal", label: "[CICLO] Respeitar o cap 4+4 de mensageria durante todo o ciclo", detalhe: "REGRA INEGOCIÁVEL: máx 4 mensagens na API (1:1) + 4 no grupo, por dia, por pessoa. Resposta reativa não conta. Trocar o nome do grupo não libera cota nova — é a mesma janela. Sobrou mensagem? Reordena, junta ou joga pro dia seguinte — nunca soma. Estourar = número bloqueado, e aí o backup vira canal principal por acidente. Detalhe em 06-mensageria-wpp/regra-cap-4mais4-mensageria.md." },
  ...
  { id: "hot-ingresso", frente: "hotmart", ordem: 3, sugestao: "gleyce", recorrencia: "unica", label: "✅ Criar produto 'Ingresso do evento' R$44", detalhe: "✅ PUBLICADO E VENDENDO (Red confirmou 21/07). ID 8124888 · checkout R106737413U · oferta x041eoi2 · R$44. Capa, descrição, forma de pagamento e área de membros concluídas. Checkout validado ao vivo (HTTP 200, Claude 21/07). Link canônico pra mensageria: `https://pay.hotmart.com/R106737413U?checkoutMode=10` (página única — menos passos, converte melhor em ticket baixo). NUNCA propagar o parâmetro `bid=` — é identificador de sessão do navegador.", tutorial: {
