...
export const TASKS: Task[] = [
  ...
  { id: "hot-ingresso", frente: "hotmart", ordem: 1, sugestao: "gleyce", recorrencia: "unica", label: "✅ Criar produto 'Ingresso do evento' R$44", detalhe: "CRIADO no Hotmart (14/07, status Em rascunho), capa 600×600 aplicada. ⚠️ Falta: definir preço R$44 PAGAMENTO ÚNICO (não assinatura), preencher descrição/perfil, anotar ID + código de checkout, e publicar.", tutorial: {
