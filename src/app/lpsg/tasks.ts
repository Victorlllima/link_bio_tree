...
export const TASKS: Task[] = [
  ...
  { id: "traf-pixel-checkout", frente: "trafego", ordem: 9, sugestao: "victor", pendencia: true, recorrencia: "unica", label: "Instalar o Pixel no CHECKOUT da Hotmart (fecha o buraco do funil)", detalhe: "⚠️ HOJE O FUNIL É CEGO no checkout: o lead sai da nossa página (InitiateCheckout ✅) e vai pro pay.hotmart.com — ali não temos visibilidade. Não sabemos se ele abandonou o carrinho, teve erro no cartão ou desistiu no pagamento. CORREÇÃO: Hotmart → Ferramentas → Pixels/Rastreamento → adicionar o Pixel 1543917230170877 (+ CAPI token) em CADA produto (IAA 8039631, Ingresso 8124888, CFB, Formação). Isso libera os eventos de checkout e Purchase direto da Hotmart.", tutorial: {
  ...
  { id: "ges-status", frente: "gestao", ordem: 4, sugestao: "gleyce", recorrencia: "semanal", label: "Relatório de status diário até o evento" },
