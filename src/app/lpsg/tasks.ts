...
export const TASKS: Task[] = [
  ...
  { id: "aut-cap44", frente: "paginas", ordem: 11, sugestao: "victor", recorrencia: "semanal", label: "✅ Aplicar o cap 4+4 na mensageria do evento", detalhe: "✅ DOCUMENTADO 19/07 (Claude): regra em 06-mensageria-wpp/regra-cap-4mais4-mensageria.md (máx 4 API + 4 grupo/dia, como contar, exemplo de dia). Consultar antes de cada disparo." },
