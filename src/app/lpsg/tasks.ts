...
export const TASKS: Task[] = [
  ...
  { id: "traf-pixel-checkout", frente: "trafego", ordem: 9, sugestao: "victor", recorrencia: "unica", label: "✅ Pixel no CHECKOUT da Hotmart (fecha o buraco do funil)", detalhe: "✅ JÁ ESTAVA CONFIGURADO (Red confirmou 14/07): \"Página de pagamento e de produto Hotmart\" → Pixel 1543917230170877 · Evento via Web = Configurado · Evento via API (CAPI) = Token configurado. É daqui que vinham os eventos Purchase vistos na auditoria. Funil 100% rastreado ponta a ponta. ⚠️ Conferir só se a config cobre os 4 produtos (IAA, Ingresso, CFB, Formação) — abrir \"Detalhes da configuração\".", tutorial: {
