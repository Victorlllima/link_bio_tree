...
export const TASKS: Task[] = [
  ...
  { id: "grp-op-link", frente: "grupo", ordem: 8, sugestao: "victor", pendencia: true, recorrencia: "semanal", label: "[CICLO] Gerar o novo link de convite e atualizar em todo lugar que aponta pra ele", detalhe: "Link deste ciclo: chat.whatsapp.com/Jtk4YdLJMFGK2S6LtUUkMr. ✅ Ligado na página de obrigado + ✅ na tela final da Aula 12 do IAA (Red 14/07). FALTA: ligar no ManyChat (grp-op-automacao)." },
