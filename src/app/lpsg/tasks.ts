...
export const TASKS: Task[] = [
  ...
  { id: "grp-op-criar", frente: "grupo", ordem: 6, sugestao: "victor", recorrencia: "semanal", label: "✅ [CICLO] Criar o grupo de WhatsApp da semana", detalhe: "Grupo novo a cada ciclo — não reaproveitar (limite de 1.000 membros do WhatsApp + escassez perde efeito com coortes misturadas). Nome VISÍVEL (todos os leads veem): 'Super Oferta — Como Construir um CRM Customizado' — SEM número de semana/ciclo (tem que parecer evento único). Diferenciar coortes só na sua lista interna, nunca no nome. Nasce FECHADO pra mensagens (só admins postam) até o momento certo. PENDÊNCIA CRÍTICA no 1º ciclo — ainda não existe e a Aula 12 do IAA já está no ar apontando pra cá." },
  { id: "grp-op-config", frente: "grupo", ordem: 7, sugestao: "victor", pendencia: true, recorrencia: "semanal", label: "[CICLO] Configurar o grupo da semana: capa, descrição, admins", detalhe: "✅ DESCRIÇÃO PRONTA em 06-mensageria-wpp/descricao-do-grupo.md (colar no grupo). Falta: 3-5 admins (Red + backup), fechar o grupo pra só admins postarem, subir a capa." },
  { id: "grp-op-link", frente: "grupo", ordem: 8, sugestao: "victor", pendencia: true, recorrencia: "semanal", label: "[CICLO] Gerar o novo link de convite e atualizar em todo lugar que aponta pra ele", detalhe: "Link deste ciclo: chat.whatsapp.com/IsvZFOVIYKmDss3tSRwrKx. ✅ JÁ ligado na página de obrigado (redpro.com.br/lpsg-obrigado). FALTA ligar em: tela final da Aula 12 do IAA + ManyChat. A cada ciclo o link muda e precisa ser trocado nesses lugares." },
  ...
  { id: "hot-reprecificar", frente: "hotmart", ordem: 2, sugestao: "gleyce", recorrencia: "unica", label: "✅ Reajustar preços do IAA e dos bumps", detalhe: "IAA R$97→R$17 · Bump 1 R$37→R$26 · Bump 2 R$27→R$35 (soma 8). FEITO 14/07: checkout T106558618V reprecificado para R$17 (alinhado com a página).", tutorial: {
  ...
  { id: "hot-retificar-cfb", frente: "hotmart", ordem: 3, sugestao: "gleyce", recorrencia: "unica", label: "✅ Retificar preço do Claude for Business (upsell): R$47 → R$62", detalhe: "FEITO 14/07: checkout V105607171C reprecificado para R$62 (alinhado com a página, soma 8)." },
  ...
  { id: "hot-areamembros-ingresso", frente: "hotmart", ordem: 9, sugestao: "ambos", pendencia: true, recorrencia: "unica", label: "Montar a área de membros do Ingresso (\"Comece por aqui\")", detalhe: "1 aula só: subir o vídeo de boas-vindas (grav-boasvindas) + colar o TEXTO de onboarding embaixo (pronto em 04-conteudo-aulas/onboarding-area-de-membros.md). Regra Tabari: só isso na Hotmart, as aulas do evento vão pelo WhatsApp. Necessário pra publicar. PENDÊNCIA." },
  { id: "hot-limpar", frente: "hotmart", ordem: 10, sugestao: "gleyce", recorrencia: "unica", label: "Limpar o Hotmart deixando só a RedPro AI Academy", tutorial: {
  ...
  { id: "hot-provasocial", frente: "hotmart", ordem: 11, sugestao: "victor", pendencia: true, recorrencia: "unica", label: "Fornecer prova social real (nome + resultado)", detalhe: "Depoimentos para os e-mails e o carrinho — só o Victor tem os casos. PENDÊNCIA." },
  ...
  { id: "aut-emails", frente: "paginas", ordem: 6, sugestao: "victor", pendencia: true, recorrencia: "unica", label: "Programar a sequência de e-mails", detalhe: "✅ CONTEÚDO PRONTO: 12 e-mails escritos em 07-emails/. Falta PROGRAMAR no Resend (config externa). PENDÊNCIA de execução." },
  ...
  { id: "traf-anuncios", frente: "trafego", ordem: 1, sugestao: "victor", recorrencia: "unica", label: "✅ Montar os anúncios de venda do ingresso", detalhe: "ROTEIROS PRONTOS: matriz de 15 criativos (5 estáticos + 5 vídeos + 5 carrosséis) em 09-criativos-trafego/. Falta: Red grava os 2 vídeos novos + LUA gera as imagens dos estáticos/carrosséis (após aprovação)." },
